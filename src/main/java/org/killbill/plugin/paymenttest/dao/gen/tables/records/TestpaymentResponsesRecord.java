...
public class TestpaymentResponsesRecord extends UpdatableRecordImpl<TestpaymentResponsesRecord> implements Record10<ULong, String, String, String, String, BigDecimal, String, String, Timestamp, String> {
     ...
     */
    @Override
    public TestpaymentResponsesRecord values(ULong value1, String value2, String value3, String value4, String value5, BigDecimal value6, String value7, String value8, Timestamp value9, String value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TestpaymentResponsesRecord(ULong recordId, String kbAccountId, String kbPaymentId, String kbPaymentTransactionId, String transactionType, BigDecimal amount, String currency, String additionalData, Timestamp createdDate, String kbTenantId) {
        super(TestpaymentResponses.TESTPAYMENT_RESPONSES);
