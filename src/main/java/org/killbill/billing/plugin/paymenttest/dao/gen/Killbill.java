...
public class Killbill extends SchemaImpl {
     ...
     */
    public final TestpaymentHppRequests TESTPAYMENT_HPP_REQUESTS = org.killbill.billing.plugin.paymenttest.dao.gen.tables.TestpaymentHppRequests.TESTPAYMENT_HPP_REQUESTS;

    /**
     * The table <code>killbill.testpayment_payment_methods</code>.
     */
    public final TestpaymentPaymentMethods TESTPAYMENT_PAYMENT_METHODS = org.killbill.billing.plugin.paymenttest.dao.gen.tables.TestpaymentPaymentMethods.TESTPAYMENT_PAYMENT_METHODS;

    /**
     * The table <code>killbill.testpayment_responses</code>.
     */
    public final TestpaymentResponses TESTPAYMENT_RESPONSES = org.killbill.billing.plugin.paymenttest.dao.gen.tables.TestpaymentResponses.TESTPAYMENT_RESPONSES;
